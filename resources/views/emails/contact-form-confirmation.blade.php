                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td class="mui-panel">
                                        ...
                                        <p>Hi {{ $name }},</p>
                                        <p>Thanks for getting in touch. I'll try my best to make sure I get back to you within the next day or so.</p>
                                        <p>Kind Regards,<br>Mubeen.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="mui--text-center"><a class="mui--text-caption mui--text-dark-hint" href="{{ config('url.website') }}">Mubeen-Inamdar.com</a></div>
                                    </td>
                                </tr>
                            </table>
